...
var NegociacaoController = function () {
    ...
    _createClass(NegociacaoController, [{
        ...
        value: function importaNegociacoes() {
            ...
            return this._service.importa(this._listaNegociacoes.negociacoes).then(function (negociacoes) {
                return negociacoes.forEach(function (negociacao) {
                    _this3._listaNegociacoes.adiciona(negociacao);
                    _this3._mensagem.texto = 'Negociações importadas com sucesso';
                });
            }).catch(function (erro) {
                return _this3._mensagem.texto = texto;
            });
        }
    }, {
        key: "apaga",
        value: function apaga() {
            ...
            return this._service.apaga().then(function (mensagem) {
